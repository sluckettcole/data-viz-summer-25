...
* Your job is to create a visualization of data from any data set
* You shoudl follow the workflow you learned today
* Give the files sensible names and commit them to GitHub
* Problems? Email me your answers.
